...
midi_mapping = {
	...
	# "solo_kill": Note(7),
	# NOTE: Was Note(2), has now been changed to Note(6)
	"mute": Note(6),

	# NOTE: The reason these have been commented out is because it is still using the old key for keybinding
	# "mute_exclusive": Note(5),
	# "mute_kill": Note(8),
	# "mute_flip": Note(9),
	# NOTE: formerly ctrl + m, but I'm using Note(6) for
	...
	"metronome": Note(12),
	# NOTE: Was Note(13) but changed to ctrl + 'v' from volume.
	"back_to_arranger": CC(22),
	"overdub": Note(14),
	...
	# NOTE: Change to back_to_arranger
